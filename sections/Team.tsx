...
export const Team = () => {
  ...
  return (
    <div className="px-4 pt-[8ch] pb-[6ch] space-y-12" style={{ boxShadow: "inset 0 -100px 80px -10px rgba(45, 179, 255, 0.05), inset 0 80px 80px -10px rgba(45, 179, 255, 0.05)" }}>
      <div className="text-center">
        ...
        <p className="sm:text-lg">a powerful, communicative team providing top-notch services that bring clients back.</p>
      </div>
